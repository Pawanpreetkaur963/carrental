...
<div class="row">
											...
											<button style="padding: 0px 5px;" id="down" class="btn btn-default" onclick=" down(<?php echo $psliderec['productid'];  ?>,'1')"><span class="fa fa-minus"></span></button>
										
										<input type="text" id="qty<?php echo $psliderec['productid'];  ?>" style="padding:.0rem .75rem;" class="form-control input-number" value="1" />
									
											<button id="up" style="padding: 0px 5px;" class="btn btn-default" onclick="up(<?php echo $psliderec['productid'];  ?>,'5')"><span class="fa fa-plus"></span></button>
